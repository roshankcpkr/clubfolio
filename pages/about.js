const About = ()=>{
    return (
        ...
        <div className="h-full w-full border md:p-16">
            <div className="flex justify-center gap-10 w-full flex-col md:flex-row p-16">
            ...
            <div className="flex justify-center gap-10 w-full flex-col md:flex-row p-16">
                <div className="w-full md:w-1/2">
                    <img src="images/image3].jpg" className="rounded-xl w-full h-[200px] md:h-[300px] object-cover" alt=""/>
                </div>
                <div className="w-full md:w-1/2">
                    <p className="font-serif text-gray-500 text-lg">MacIThub is a student club of Mount Annapurna Campus, Pokhara. MacIThub is a platform for all the tech enthusiasts, who want 
                        to share skills, explore and learn different tech stuffs. This club will come in
                         handy in the upcoming days hosting Expos, Bootcamps, Workshops and different seminars. Also a good place to keep the ideas flowing.</p>
                </div>
            </div>
            <div className="p-16">
                ...
                <div class="w-full relative cursor-pointer ">
                <img class="rounded-xl w-full h-[200px] md:h-[400px] object-cover" src="/images/sulav.jpg" alt="" />
                <div class="absolute flex flex-col p-6 rounded-b-xl justify-between bottom-0 w-full h-3/3 bg-green-600 bg-opacity-70">
                    <div class=" self-right text-center justify-between text-white">
                        <h4 class="text-xl font-bold">Sulav Parajuli</h4>
                        <p class="mt-1 text-md font-semibold">Fifth semester student</p>
                    </div>
                </div>
                </div>
